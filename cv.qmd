...
::: cv_img
![](/assets/img/GRC_logo_horiz_2024.png){fig-alt="Government Resource Center logo"}
:::

::: h3
Government Resource Center at The Ohio State University
:::
:::

[R/Shiny Developer]{.h4} [August 2024 - Present]{.cv-date}

-   Develop Shiny web apps using {golem} framework
-   Develop R packages by refactoring and documenting existing code
...
[IS Business Automation Specialist]{.h4} [June 2023 - August 2024]{.cv-date}

-   Automated DHS’s org charts for 7,000+ employees, saving 60 hours annually
-   Serve as liaison for remote work policy by determining which employees meet criteria for remote work through combining
multiple unclean data sources
...
[Highway Safety Data Analyst]{.h4} [May 2019 - June 2023]{.cv-date}
...
[Data Processor]{.h4} [Dec 2016 - May 2019]{.cv-date}
...
[Traffic Forecaster (Part-time)]{.h4} [Feb 2014 -- June 2018]{.cv-date}
...
[Bicycle and Pedestrian Intern (Part-time)]{.h4} [Mar 2015 -- July 2015]{.cv-date}
...
[Master of Science]{.h4} [2012 - 2014]{.cv-date}
...
[Bachelors of Science]{.h4} [2006 - 2010]{.cv-date}
